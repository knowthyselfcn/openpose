...
int openPoseTutorialPose1()
{
    ...
    FLAGS_model_folder = "/home/rein/openpose/models/";
    FLAGS_image_path = "/home/rein/openpose/examples/media/COCO_val2014_000000000192.jpg";

    std::cout << "netInputSize: " << netInputSize << std::endl;
    std::cout << "netOutputSize: " << netOutputSize << std::endl;
    std::cout << "outputSize: " << outputSize << std::endl;
    std::cout << "FLAGS_num_scales: " << FLAGS_num_scales << std::endl;
    std::cout << "FLAGS_scale_gap: " << FLAGS_scale_gap << std::endl;
    std::cout << "FLAGS_model_folder: " << FLAGS_model_folder << std::endl;
    std::cout << "FLAGS_num_gpu_start: " << FLAGS_num_gpu_start << std::endl;
    std::cout << "FLAGS_image_path: " << FLAGS_image_path << std::endl;
